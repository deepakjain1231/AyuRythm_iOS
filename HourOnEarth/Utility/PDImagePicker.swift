...
open class PDImagePicker: NSObject {
    ...
    public func present(from sourceView: UIView? = nil, is_video: Bool = false) {
        ...
        let alertController = UIAlertController(title: "Choose image from".localized(), message: nil, preferredStyle: .actionSheet)
        ...
        var sttr_Text = "Photo library".localized()
        if is_video {
            sttr_Text = "Photo & Video library".localized()
        }
