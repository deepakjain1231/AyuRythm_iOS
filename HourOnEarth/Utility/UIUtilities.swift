...
public class UIUtilities {
  ...
  public static func addCircle(
    ...
    circleView.accessibilityIdentifier = Constant.circleViewIdentifier
  ...
  public static func addLineSegment(
    ...
    lineView.accessibilityIdentifier = Constant.lineViewIdentifier
  ...
  public static func addRectangle(_ rectangle: CGRect, to view: UIView, color: UIColor) {
    ...
    rectangleView.accessibilityIdentifier = Constant.rectangleViewIdentifier
...
//  public static func applySegmentationMask(mask: SegmentationMask, to imageBuffer: CVImageBuffer, backgroundColor: UIColor?, foregroundColor: UIColor?) {
//    assert(
...
//    var maskAddress =
//      CVPixelBufferGetBaseAddress(mask.buffer)!.bindMemory(to: Float32.self, capacity: Int(maskBytesPerRow * height))
//
...
//  }
  ...
  public static func createUIImage(
    ...
    return UIImage(cgImage: cgImage, scale: Constant.originalScale, orientation: orientation)
  }
...
//  public static func createPoseOverlayView(forPose pose: Pose, inViewWithBounds bounds: CGRect, lineWidth: CGFloat, dotRadius: CGFloat,
