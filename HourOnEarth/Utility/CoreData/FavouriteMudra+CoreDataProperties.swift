//
//  FavouriteMudra+CoreDataProperties.swift
//  HourOnEarth
//
...
extension FavouriteMudra {

    @nonobjc public class func fetchRequest() -> NSFetchRequest<FavouriteMudra> {
        return NSFetchRequest<FavouriteMudra>(entityName: "FavouriteMudra")
    }

    @NSManaged public var benefit_description: String?
    @NSManaged public var descriptionMudra: String?
