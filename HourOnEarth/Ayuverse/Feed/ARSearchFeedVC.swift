//
//  ARSearchFeedVC.swift
//  HourOnEarth
//
//  Created by DEEPAK JAIN on 06/10/22.
...
class ARSearchFeedVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.txt_Search.text = self.str_Search
        self.lbl_Nodata_subTitle.textAlignment = .center
        setupUI()
    }
    
    override func viewWillAppear(_ animated: Bool) {
        searchFeedFromServer(text: self.str_Search){ (success) in
...
extension ARSearchFeedVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let dic_Feed = feeds[indexPath.row]
...
extension ARSearchFeedVC: ARAyuverseFeedCellDelegate, delegate_repot {
...
extension ARSearchFeedVC: UITextFieldDelegate {
