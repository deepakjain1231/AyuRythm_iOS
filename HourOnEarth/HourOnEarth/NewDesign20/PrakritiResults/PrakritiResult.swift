...
class PrakritiResult: UIViewController,UITableViewDelegate, UITableViewDataSource {
    ...
    @IBOutlet weak var tblPrakritiResult: UITableView!
    @IBOutlet weak var tblPrakritiResultFirst: UITableView!
    @IBOutlet weak var tblPrakritiResultSecond: UITableView!
    ...
    @IBOutlet weak var lblKaphaPercentageFirst: UILabel!
    @IBOutlet weak var lblPittaPercentageFirst: UILabel!
    @IBOutlet weak var lblVataPercentageFirst: UILabel!
    @IBOutlet weak var lblKaphaPercentageSecond: UILabel!
    @IBOutlet weak var lblPittaPercentageSecond: UILabel!
    @IBOutlet weak var lblVataPercentageSecond: UILabel!
    @IBOutlet weak var lblDescription: UILabel!
    @IBOutlet weak var lblTitleImbalance: UILabel!
    @IBOutlet weak var lblTitleImbalanceFirst: UILabel!
    @IBOutlet weak var lblTitleImbalanceSecond: UILabel!
    @IBOutlet weak var imgImbalance: UIImageView!
    @IBOutlet weak var imgImbalanceFirst1: UIImageView!
    @IBOutlet weak var imgImbalanceFirst2: UIImageView!
    @IBOutlet weak var imgImbalanceFirst3: UIImageView!
    @IBOutlet weak var imgImbalanceSecond1: UIImageView!
    @IBOutlet weak var imgImbalanceSecond2: UIImageView!

    var kpvDescription = ""
    var yourIdealState = ""
    var isRegisteredUser = true
    var isFromResultHistory = false
    @IBOutlet weak var viewback: UIView!
//    @IBOutlet weak var viewsubBack: UIView!
    @IBOutlet weak var viewbackFirst: UIView!
//    @IBOutlet weak var viewsubBackFirst: UIView!
    @IBOutlet weak var viewbackSecond: UIView!
//    @IBOutlet weak var viewsubBackSecond: UIView!
    ...
    override func viewDidLoad() {
      ...
      //  tblPrakritiResult.isHidden = false
      //  tblPrakritiResultFirst.isHidden = true
      //  tblPrakritiResultSecond.isHidden = true

//        self.viewback.shadowOnVIew(.Black)
//        self.viewsubBack.shadowOnVIew(.Black)
//        self.viewbackFirst.shadowOnVIew(.Black)
//        self.viewsubBackFirst.shadowOnVIew(.Black)
//        self.viewbackSecond.shadowOnVIew(.Black)
//        self.viewsubBackSecond.shadowOnVIew(.Black)

//        self.title = "Your Ideal State".localized()
//        let shareButtonItem = UIBarButtonItem(image: #imageLiteral(resourceName: "ic_Share.png"), style: .plain, target: self, action: #selector(sharePrakritiResultButtonAction(sender:)))
//        if !isFromResultHistory {
////            self.navigationItem.setHidesBackButton(true, animated: false)
////            self.navigationController?.isNavigationBarHidden = true
//            // MARK :- set Done button and Color.
//            let rightButtonItem = UIBarButtonItem(title: "Done".localized(), style: .plain, target: self, action: #selector(rightButtonAction(sender:)))
...
//        }
        ...
        self.tblPrakritiResult.estimatedRowHeight = 200
        self.tblPrakritiResult.rowHeight = UITableView.automaticDimension
        self.tblPrakritiResultFirst.estimatedRowHeight = 200
        self.tblPrakritiResultFirst.rowHeight = UITableView.automaticDimension
        self.tblPrakritiResultSecond.estimatedRowHeight = 200
        self.tblPrakritiResultSecond.rowHeight = UITableView.automaticDimension

        tblPrakritiResult.register(UINib(nibName: "PrakritiDetailCell", bundle: nil), forCellReuseIdentifier: "PrakritiDetailCell")
        tblPrakritiResultFirst.register(UINib(nibName: "PrakritiDetailCell", bundle: nil), forCellReuseIdentifier: "PrakritiDetailCell")
        tblPrakritiResultSecond.register(UINib(nibName: "PrakritiDetailCell", bundle: nil), forCellReuseIdentifier: "PrakritiDetailCell")
        configureUI()
        self.tblPrakritiResult.reloadData()
        self.tblPrakritiResultFirst.reloadData()
        self.tblPrakritiResultSecond.reloadData()
    }
    
    override func viewDidLayoutSubviews() {
        super.viewDidLayoutSubviews()
//        print("self.viewsubBackFirst=",self.viewsubBackFirst.bounds)
    ...
    @objc func sharePrakritiResultButtonAction(sender: UIBarButtonItem) {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "PrakritiDetailCell") as? PrakritiDetailCell else {
            return UITableViewCell()
        }
        cell.configureCell(description: kpvDescription)
    ...
    func configureUI() {
        ...
        self.lblKaphaPercentageFirst.text = "\(Int(percentKapha))%"
        self.lblPittaPercentageFirst.text = "\(Int(percentPitta))%"
        self.lblVataPercentageFirst.text = "\(Int(percentVata))%"
        self.lblKaphaPercentageSecond.text = "\(Int(percentKapha))%"
        self.lblPittaPercentageSecond.text = "\(Int(percentPitta))%"
        self.lblVataPercentageSecond.text = "\(Int(percentVata))%"
        
        let currentPraktitiStatus = Utils.getYourCurrentPrakritiStatus()
        
        switch currentPraktitiStatus {
        case .TRIDOSHIC:
            tblPrakritiResult.isHidden = true
            tblPrakritiResultFirst.isHidden = false
            tblPrakritiResultSecond.isHidden = true

            imgImbalanceFirst1.image = UIImage(named: "vataInfoCombined")
            imgImbalanceFirst2.image = UIImage(named: "pittaInfoCombined")
            imgImbalanceFirst3.image = UIImage(named: "kaphaInfoCombined")
            yourIdealState = "You are tridoshic".localized()
            self.lblTitleImbalanceFirst.text = yourIdealState
...
extension PrakritiResult {
    
    func updateUIForKaphaPitta() {
        tblPrakritiResult.isHidden = true
        tblPrakritiResultFirst.isHidden = true
        tblPrakritiResultSecond.isHidden = false

        imgImbalanceSecond2.image = UIImage(named: "pittaInfoCombined")
        imgImbalanceSecond1.image = UIImage(named: "kaphaInfoCombined")
        yourIdealState = "Your predominant dosha is Kapha-Pitta".localized()
        self.lblTitleImbalanceSecond.text = yourIdealState
    ...
    func updateUIForPittaKapha() {
        ...
        imgImbalanceSecond1.image = UIImage(named: "pittaInfoCombined")
        imgImbalanceSecond2.image = UIImage(named: "kaphaInfoCombined")
        yourIdealState = "Your predominant dosha is Pitta-Kapha".localized()
        self.lblTitleImbalanceSecond.text = yourIdealState
...
//        self.viewsubBackSecond.gradientOnView([UIColor(red: 250.0 / 255.0, green: 219.0 / 255.0, blue: 199.0 / 255.0, alpha: 1.0).cgColor,UIColor(red: 206.0 / 255.0, green: 234.0 / 255.0, blue: 205.0 / 255.0, alpha: 1.0).cgColor], CGRect(x: 0.0, y: 0.0, width: self.view.frame.width - 32, height: 55.0))
    }
    ...
    func updateUIForPittaVata() {
        ...
        imgImbalanceSecond2.image = UIImage(named: "vataInfoCombined")
        imgImbalanceSecond1.image = UIImage(named: "pittaInfoCombined")
        yourIdealState = "Your predominant dosha is Pitta-Vata".localized()
        self.lblTitleImbalanceSecond.text = yourIdealState
    ...
    func updateUIForVataKapha() {
        ...
        imgImbalanceSecond2.image = UIImage(named: "kaphaInfoCombined")
        imgImbalanceSecond1.image = UIImage(named: "vataInfoCombined")
        yourIdealState = "Your predominant dosha is Vata-Kapha".localized()
        self.lblTitleImbalanceSecond.text = yourIdealState
    ...
    func updateUIForVataPitta() {
        ...
        imgImbalanceSecond1.image = UIImage(named: "vataInfoCombined")
        imgImbalanceSecond2.image = UIImage(named: "pittaInfoCombined")
        yourIdealState = "Your predominant dosha is Vata-Pitta".localized()
        self.lblTitleImbalanceSecond.text = yourIdealState
...
//        self.viewsubBackSecond.gradientOnView([UIColor(red: 190.0 / 255.0, green: 218.0 / 255.0, blue: 247.0 / 255.0, alpha: 1.0).cgColor,UIColor(red: 248.0 / 255.0, green: 197.0 / 255.0, blue: 207.0 / 255.0, alpha: 1.0).cgColor], CGRect(x: 0.0, y: 0.0, width: self.view.frame.width - 32, height: 55.0))
    }
    ...
    func updateUIForKaphaVata() {
        ...
        imgImbalanceSecond1.image = UIImage(named: "kaphaInfoCombined")
        imgImbalanceSecond2.image = UIImage(named: "vataInfoCombined")
        yourIdealState = "Your predominant dosha is Kapha-Vata".localized()
        self.lblTitleImbalanceSecond.text = yourIdealState
...
//        self.viewsubBackSecond.gradientOnView([UIColor(red: 206.0 / 255.0, green: 234.0 / 255.0, blue: 205.0 / 255.0, alpha: 1.0).cgColor,UIColor(red: 190.0 / 255.0, green: 218.0 / 255.0, blue: 247.0 / 255.0, alpha: 1.0).cgColor], CGRect(x: 0.0, y: 0.0, width: self.view.frame.width - 32, height: 55.0))
    }
    ...
    func updateUIForKapha() {
        ...
        imgImbalance.image = UIImage(named: "kaphaInfoCombined")
        yourIdealState = "Your predominant dosha is Kapha".localized()
        self.lblTitleImbalance.text = yourIdealState
        self.lblDescription.text = "Calm\nThoughtful\nLoving\nEnjoys life\nComfortable\nwith routine".localized()
...
//        self.viewsubBack.backgroundColor = UIColor().hexStringToUIColor(hex:"E6F5E6")
    }
    ...
    func updateUIForPitta() {
        ...
        imgImbalance.image = UIImage(named: "pittaInfoCombined")
        yourIdealState = "Your predominant dosha is Pitta".localized()
        self.lblTitleImbalance.text = yourIdealState
        self.lblDescription.text = "Intellectual\nFocused\nPrecise\nDirect\nPassionate".localized()
...
//        self.viewsubBack.backgroundColor = UIColor().hexStringToUIColor(hex:"FADBC7")
    }
    ...
    func updateUIForVata() {
        ...
        imgImbalance.image = UIImage(named: "vataInfoCombined")
        yourIdealState = "Your predominant dosha is Vata".localized()
        self.lblTitleImbalance.text = yourIdealState
        self.lblDescription.text = "Spontaneous\nEnthusiastic\nCreative\nFlexible\nEnergetic".localized()
...
//        self.viewsubBack.backgroundColor = UIColor().hexStringToUIColor(hex:"DFEDFB")
    }
}
