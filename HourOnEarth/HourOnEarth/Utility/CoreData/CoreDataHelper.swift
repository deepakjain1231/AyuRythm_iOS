...
//  Field_Engineer
//
//  Created by Pradeep Kumar Yadav on 02/12/15.
...
class CoreDataHelper: NSObject {
    ...
    static var sharedInstance:CoreDataHelper = CoreDataHelper()
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        //TODO: ADD DATABASE
        let modelURL = Bundle.main.url(forResource: "Hoe", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        //TODO: ADD NAME
        let url = self.applicationDocumentsDirectory.appendingPathComponent("Hoe.sqlite")
...
//    {
//        if CoreDataHelper.sharedInstance == nil{
//
//            CoreDataHelper.sharedInstance = CoreDataHelper()
//        }
...
//    }
   ...
   func createEntityWithName(_ entityName:String ,uniqueKey primaryKey:String? ,value keyValue:String?) -> NSManagedObject
    ...
    func clearAllDataFrom(entityName: String) {
        let entities = self.getListOfEntityWithName(entityName, withPredicate: nil, sortKey: nil , isAscending: false) as? [NSManagedObject] ?? []
