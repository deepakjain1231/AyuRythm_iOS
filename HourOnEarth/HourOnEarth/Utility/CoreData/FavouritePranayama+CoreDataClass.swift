//
//  FavouritePranayama+CoreDataClass.swift
//  HourOnEarth
//
...
@objc(FavouritePranayama)
public class FavouritePranayama: NSManagedObject {
    class func createPranayamaData(dicData: [String: Any]) -> FavouritePranayama? {
        ...
        guard let entity = CoreDataHelper.sharedInstance.createEntityWithName("FavouritePranayama", uniqueKey: "id", value: id) as? FavouritePranayama else {
            return nil
        }
            entity.id = Int(id) ?? 0
