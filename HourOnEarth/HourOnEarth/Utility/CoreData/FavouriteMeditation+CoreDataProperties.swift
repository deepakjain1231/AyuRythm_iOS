//
//  FavouriteMeditation+CoreDataProperties.swift
//  HourOnEarth
//
...
extension FavouriteMeditation {

    @nonobjc public class func fetchRequest() -> NSFetchRequest<FavouriteMeditation> {
        return NSFetchRequest<FavouriteMeditation>(entityName: "FavouriteMeditation")
    }

    @NSManaged public var benefit_description: String?
    @NSManaged public var descriptionMeditation: String?
