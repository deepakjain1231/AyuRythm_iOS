//
//  FavouriteKriya+CoreDataProperties.swift
//  HourOnEarth
//
...
extension FavouriteKriya {

    @nonobjc public class func fetchRequest() -> NSFetchRequest<FavouriteKriya> {
        return NSFetchRequest<FavouriteKriya>(entityName: "FavouriteKriya")
    }
