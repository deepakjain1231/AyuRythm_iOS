//
//  FavouriteMeditation+CoreDataClass.swift
//  HourOnEarth
//
...
@objc(FavouriteMeditation)
public class FavouriteMeditation: NSManagedObject {
    class func createMeditationData(dicData: [String: Any]) -> FavouriteMeditation? {
        ...
        guard let entity = CoreDataHelper.sharedInstance.createEntityWithName("FavouriteMeditation", uniqueKey: "id", value: id) as? FavouriteMeditation else {
            return nil
        }
           entity.id = Int(id) ?? 0
            ...
            entity.descriptionMeditation = dicData["description"] as? String ?? ""
