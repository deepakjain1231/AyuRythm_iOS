//
//  FavouriteMudra+CoreDataClass.swift
//  HourOnEarth
//
...
@objc(FavouriteMudra)
public class FavouriteMudra: NSManagedObject {
    class func createMudraData(dicData: [String: Any]) -> FavouriteMudra? {
        ...
        guard let entity = CoreDataHelper.sharedInstance.createEntityWithName("FavouriteMudra", uniqueKey: "id", value: id) as? FavouriteMudra else {
            return nil
        }
           entity.id = Int(id) ?? 0
