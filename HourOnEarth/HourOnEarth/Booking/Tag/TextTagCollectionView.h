...
@interface TextTagConfig : NSObject;
// Text font
...
@class TextTagCollectionView;

@protocol TextTagCollectionViewDelegate <NSObject>
@optional

- (BOOL)textTagCollectionView:(TextTagCollectionView *)textTagCollectionView
                    canTapTag:(NSString *)tagText
                      atIndex:(NSUInteger)index
              currentSelected:(BOOL)currentSelected
                    tagConfig:(TextTagConfig *)config;

- (void)textTagCollectionView:(TextTagCollectionView *)textTagCollectionView
...
@interface TextTagCollectionView : UIView
// Delegate
...
// Default tag config
@property (nonatomic, strong) TextTagConfig *defaultConfig;
